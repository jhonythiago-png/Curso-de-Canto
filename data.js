const lessonData = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>"Deus é amor" em notas graves: DEUS (Dó grave - 2s) -> É (mesma nota - 1s) -> AMOR (Ré grave - 3s sustentado). Grave-se e ouça: parece forçado ou natural?</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Em nota confortável (Dó ou Ré): inspire por 4 segundos e solte em "AAAAH" por 8 segundos mantendo intensidade constante do início ao fim. Mão no abdômen – deve estar firme. Repita 5x.</p>
      ...
      <p>"CANTO PORQUE TU ÉS BOM" em notas médias estáveis (tom C): Dó-Ré-Mi -> Mi-Ré -> Dó -> Ré -> Mi sustentado. Cante com apoio constante, ressonância ativa e intenção genuína de louvor.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>A sílaba NO mantém a laringe baixa – ideal para agudos. Comece no médio (Dó) e suba nota a nota, cada NO leve e sem esforço.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Dó (6s) -> Ré (6s) -> Mi (6s) em uma única respiração. Respire fundo antes do Dó e apenas depois do Mi. Este exercício treina economia de ar e controle de intensidade.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Escala com dinâmica (5 min):</strong> Use Dó-Ré-Mi-Fá-Sol subindo nos três patamares. Mantenha afinação idêntica nos três volumes.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Dó->Ré->Mi->Fá->Sol->Fá->Mi->Ré->Dó, 6x sem parar. Apenas uma respiração rápida entre ciclos. Sinta o abdômen trabalhar.</p>
