const lessonData = [
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Passo 3: Mantenha o som estável em uma nota confortável (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button> <button class="play-note-btn" data-note="349.23">Fá</button> <button class="play-note-btn" data-note="392.00">Sol</button>)</li>
      </ul>
      ...
      <ul>
        ...
        <li>Segure por 5 segundos em uma nota confortável (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button> <button class="play-note-btn" data-note="349.23">Fá</button> <button class="play-note-btn" data-note="392.00">Sol</button>)</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Com as mãos na cintura e o abdômen relaxado, diga "HA" curto e seco – sinta o abdômen contrair rapidamente. Repita: HA HA HA HA HA. Agora em uma nota confortável (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button>), com intensidade crescente, sem gritar. Cada "HA" deve durar 0,5 segundo.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Coloque a mão no rosto para sentir a vibração. Grave cada vogal em uma nota confortável (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button> <button class="play-note-btn" data-note="349.23">Fá</button> <button class="play-note-btn" data-note="392.00">Sol</button>) por 3 segundos cada, mantendo a vibração facial durante todo o som:</p>
      <ul>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Escolha uma nota grave confortável (Ex: <button class="play-note-btn" data-note="130.81">Dó grave</button> <button class="play-note-btn" data-note="146.83">Ré grave</button> <button class="play-note-btn" data-note="164.81">Mi grave</button>). Inspire 4s -> "OOOH" sustentado por 8 segundos -> Mantenha a mesma potência do início ao fim, sentindo o peito vibrar todo o tempo. DICA: Se a nota sumir no meio, é porque inspirou pouco.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>"Mmmmm" boca fechada, intensidade leve. Apenas uma nota confortável por vez (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button> <button class="play-note-btn" data-note="349.23">Fá</button> <button class="play-note-btn" data-note="392.00">Sol</button>), mantendo por 10 segundos. Faça pausas de 5 segundos entre repetições. Objetivo: relaxamento, não esforço.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Em nota confortável (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button>), pronuncie cada vogal por 5 segundos exagerando a posição da boca: AAA (boca aberta, língua baixa) -> EEE (sorriso leve) -> III (lábios esticados) -> OOO (lábios redondos) -> UUU (lábios fechados). Isso treina a musculatura orofacial.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Coluna ereta, inspire fundo e solte em "OOOOH" no grave mais confortável (Ex: <button class="play-note-btn" data-note="130.81">Dó grave</button> <button class="play-note-btn" data-note="146.83">Ré grave</button> <button class="play-note-btn" data-note="164.81">Mi grave</button>). Sinta a vibração no peito com a mão. O grave não se força – ele acontece quando o corpo relaxa.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>3 min - Humming em nota confortável:</strong> Escolha UMA nota que soa bem para você (Ex: <button class="play-note-btn" data-note="261.63">Dó</button> <button class="play-note-btn" data-note="293.66">Ré</button> <button class="play-note-btn" data-note="329.63">Mi</button> <button class="play-note-btn" data-note="349.23">Fá</button> <button class="play-note-btn" data-note="392.00">Sol</button>) e fique nela. Sinta a vibração no rosto sem esforço. Não mude de nota, não teste alcance.</li>
